...
return [
    ...
    'datafeed_stale_cache_ttl' => env('VATSIM_DATAFEED_STALE_CACHE_TTL', 86400),
    ...
    'transceiver_cache_ttl' => env('VATSIM_TRANSCEIVER_CACHE_TTL', 120),
    'aerodrome_summary_cache_ttl' => env('VATSIM_AERODROME_SUMMARY_CACHE_TTL', 60),
